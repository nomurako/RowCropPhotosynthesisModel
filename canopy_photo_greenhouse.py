...
def create_grid_points_uniform(list_edge_negative_y, list_edge_positive_y, Nx_per_row, Ny_per_row, Nz_per_row, Nx_per_btm, Ny_per_btm, W_margin, L_margin):
    ...
    # for i in np.arange(1,ix-1, step=2):
...
# 直達光の計算
##################################################################
def cal_beam_radiation(x_c, y_c, z_c, azm_sun_row_coord, beta, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, LD, O_av, I0_beam_h, scatter_coef):
    '''
...
def cal_diffuse_radiation_by_trapezoid(x_c, y_c, z_c, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, I0_dif_h, O_av, scatter_coef, LD, azm, beta):
    '''
...
def cal_reflected_radiation_by_trapezoid(x_c, y_c, z_c, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, O_av, scatter_coef, reflect_coef_ground, LD, interp_I_g_h, alpha, theta):
    '''
...
def cal_absorbed_radiation(x_c, y_c, z_c, azm_sun_row_coord, beta, H_row, W_row, W_path, 
                           ...
                           LD, dV, dA, O_av, I0_beam_h, I0_dif_h, scatter_coef,
    ...
    I_beam_scattered_abs = cal_absorbed_beam_scattered_radiation(x_c, y_c, z_c, azm_sun_row_coord, beta, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, LD, O_av, I0_beam_h, scatter_coef)
    ...
    I_dif_abs = cal_two_dimensional_integral_by_trapezoid(N1, N2, a1, b1, a2, b2, max_iter, acceptable_absolute_error, 
                                                          ...
                                                          x_c, y_c, z_c, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, I0_dif_h, O_av, scatter_coef, LD)
    ...
    I_ref_abs = cal_two_dimensional_integral_by_trapezoid(N1, N2, a1, b1, a2, b2, max_iter, acceptable_absolute_error, 
                                                          ...
                                                          x_c, y_c, z_c, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, O_av, scatter_coef, 
...
def cal_absorbed_beam_scattered_radiation(x_c, y_c, z_c, azm_sun_row_coord, beta, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, LD, O_av, I0_beam_h, scatter_coef):
    '''
...
def cal_absorbed_diffuse_radiation_by_trapezoid(x_c, y_c, z_c, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, I0_dif_h, O_av, scatter_coef, LD, azm, beta):
    '''
...
def cal_absorbed_reflected_radiation_by_trapezoid(x_c, y_c, z_c, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, O_av, scatter_coef, reflect_coef_ground, LD, interp_I_g_h, alpha, theta):
    '''
...
def main(myTime, Solar_elev, azm_sun_row_coord, 
    ...
    # df_radiation["I_beam_h"] = df_radiation.swifter.apply(lambda row:cal_beam_radiation(row["x"],row["y"],row["z"], azm_sun_row_coord, Solar_elev, H_row, W_row, W_path, list_edge_negative_y, list_edge_positive_y, LD, O_av, I0_beam_h, scatter_coef),axis=1)
